    ...
    <div className="app">
      <header className="header">
        ...
        <p className="header-title">
          Bizning manzil <strong>Toshkent</strong> shahrida Bodomzor &#x24C2;
          metro ro'parasida joylashgan kela olsangiz formani to'ldiring
        </p>
      </header>
      <form onSubmit={handleSubmit} className="form" id="requestForm">
        ...
        <div className="form-group">
          <label style={{ fontSize: "15px" }}>
            Farzandingiz kursimizga qaysi vaqtlarda qatnasha oladi?{" "}
          </label>
          <Checkbox.Group
            options={timeOptions}
