...
function Kiberxavfsizlik() {
  ...
  const sheetUrl =
    "https://script.google.com/macros/s/AKfycbyKYKjGdsI3zFIcEMUXlvSDGyiMpCGs-ZUjkf8jjCZYFC_niPUOHvR0gd7my7RUsmE3/exec";
    ...
    <div className="app">
      <header className="header">
        ...
        <p className="header-title">
          Bizning kurslar <strong>Toshkent</strong> shahrida kela olsangiz
          formani to'ldiring
        </p>
      </header>
...
export default Kiberxavfsizlik;
